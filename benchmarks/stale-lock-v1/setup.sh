...
RUNTIME_ROOT="${KYBENCH_RUNTIME_ROOT:-/tmp/deploy-ops}"

log() { printf '[stale-lock-v1:setup] %s\n' "$*"; }
die() { printf '[stale-lock-v1:setup][ERROR] %s\n' "$*" >&2; exit 1; }
...
log "creating stale/active lock fixtures"
