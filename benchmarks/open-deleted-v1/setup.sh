...
RUNTIME_ROOT="${KYBENCH_RUNTIME_ROOT:-/tmp/report-ops}"

log() { printf '[open-deleted-v1:setup] %s\n' "$*"; }
die() { printf '[open-deleted-v1:setup][ERROR] %s\n' "$*" >&2; exit 1; }
...
log "starting open-deleted fixture"
